...
import WebSocketClient from './ReconnectingSocket'

const _ = require('lodash')
const debug = require('debug')('BitMEX:realtime-api:socket')

const createSocket = function (options, bmexClient) {
  'use strict'
  ...
  wsClient.onmessage = function (data) {
    ...
    const tableNoSymbol = _.includes(bmexClient.noSymbolTables, data.table)
    if (tableNoSymbol) {
