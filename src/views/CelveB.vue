<template>
  <div class="home">
    ...
    <a-row :gutter="16">
      ...
      <a-col :lg="7">
        <celve-b-pannel @insert="insertCelve" @stop="stopCelve" @update="updateCelve" :celves="celves" :user="currentUser"></celve-b-pannel>
      </a-col>
    </a-row>
  </div>
</template>
...
import CelveBPannel from '@/components/CelveBPannel.vue'
